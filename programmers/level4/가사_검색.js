// 문제 해설
/* 
본 문제는 정확성과 효율성 테스트 각각 점수가 있는 문제입니다. => means 클래스 문제

정규표현식 사용하는 경우 효율성 테스트를 통과 못함
*/
// submit solution
...
// my solution => 효율성 테스트 탈락 (55.0 / 100)
// class PatternFinder {
//   constructor(query) {
//     this.count = 0;
//     this.length = String(query).length;
//     this.query = String(query).replaceAll('?', '.');
//   }
...
//       return false;
//     } else {
//       let pattern = new RegExp(this.query, 'g');
...
//     let finder = new PatternFinder(query);
//     let arr = [];
//     let count = 0;
//     for (let word of words) {
//       arr.push(finder.regTest(word));
//     }
//     for (let i of arr) {
//       if (i) count++;
//     }
