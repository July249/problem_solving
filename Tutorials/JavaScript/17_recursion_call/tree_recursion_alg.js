...
1의 왼쪽 서브 트리로 이동합니다.
2의 왼쪽 서브 트리로 이동합니다.
더 이상 왼쪽 서브 트리가 없어 "4"를 방문합니다.
4의 오른쪽 서브 트리가 없기에 올라갑니다.
"2"를 방문합니다.
2의 오른쪽 서브 트리로 이동합니다.
더 이상 왼쪽 서브 트리가 없어 "5"를 방문합니다.
5의 오른쪽 서브 트리가 없기에 올라갑니다.
2에서 왼쪽, 오른쪽 서브 트리를 모두 방문했기에 다시 올라갑니다.
"1"을 방문합니다.
1의 오른쪽 서브 트리로 이동합니다.
3의 왼쪽 서브 트리로 이동합니다.
더 이상 왼쪽 서브 트리가 없어 "6"을 방문합니다.
6의 오른쪽 서브 트리가 없기에 올라갑니다.
"3"을 방문합니다.
3의 오른쪽 서브 트리로 이동합니다.
7의 왼쪽 서브 트리로 이동합니다.
더 이상 왼쪽 서브 트리가 없어 "8"을 방문합니다.
8의 오른쪽 서브 트리가 없기에 올라갑니다.
"7"을 방문합니다.
7의 오른쪽 서브 트리로 이동합니다.
더 이상 왼쪽 서브 트리가 없어 "9"를 방문합니다.
모든 트리를 순회했기에 종료됩니다.
...
1의 왼쪽 서브 트리로 이동합니다.
2의 왼쪽 서브 트리로 이동합니다.
더 이상 왼쪽, 오른쪽 서브 트리가 없어 "4"를 방문합니다.
올라갑니다.
2의 오른쪽 서브 트리로 이동합니다.
더 이상 왼쪽, 오른쪽 서브 트리가 없어 "5"를 방문합니다.
모든 서브 트리를 방문하였기에 "2"를 방문합니다.
올라갑니다.
1의 오른쪽 서브 트리로 이동합니다.
3의 왼쪽 서브 트리로 이동합니다.
더 이상 왼쪽, 오른쪽 서브 트리가 없어 "6"을 방문합니다.
올라갑니다.
3의 오른쪽 서브 트리로 이동합니다.
7의 왼쪽 서브 트리로 이동합니다.
더 이상 왼쪽, 오른쪽 서브 트리가 없어 "8"을 방문합니다.
올라갑니다.
7의 오른쪽 서브 트리로 이동합니다.
더 이상 왼쪽, 오른쪽 서브 트리가 없어 "9"를 방문합니다.
올라갑니다.
더 이상 왼쪽, 오른쪽 서브 트리가 없어 "7"을 방문합니다.
올라갑니다.
더 이상 왼쪽, 오른쪽 서브 트리가 없어 "3"을 방문합니다.
올라갑니다.
더 이상 왼쪽, 오른쪽 서브 트리가 없어 "1"을 방문합니다.
